...
export default function HomePage() {
  return (
    ...
    >
      <main className="relative min-h-screen overflow-x-hidden pb-27.5 lg:overflow-hidden lg:pb-14">
        ...
        <div className="relative mx-auto w-full max-w-390 px-4 py-4 sm:px-6 sm:py-8 lg:px-8 lg:py-8">
